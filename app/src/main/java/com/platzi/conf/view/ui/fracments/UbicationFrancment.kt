...
import com.platzi.conf.model.Ubicacion
import kotlinx.android.synthetic.main.fragment_ubication.*

/**
 * A simple [Fragment] subclass.
 */
class UbicationFrancment : Fragment(), OnMapReadyCallback,GoogleMap.OnMarkerClickListener  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mapFragment = childFragmentManager.findFragmentById(R.id.fmMapgoogle) as SupportMapFragment
        mapFragment.getMapAsync(this)
    }

    override fun onMapReady(googleMap: GoogleMap?) {
        val ubication = Ubicacion()
        val zoom = 16f
